...
bool ros_babel_fish_test_msgs__msg__test_sub_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_babel_fish_test_msgs.msg._test_sub_array.TestSubArray", full_classname_dest, 57) == 0);
  }
  ros_babel_fish_test_msgs__msg__TestSubArray * ros_message = _ros_message;
  {  // ints
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      int32_t * dest = ros_message->ints.data;
  ...
  {  // times
    ...
    Py_ssize_t size = 42;
    builtin_interfaces__msg__Time * dest = ros_message->times;
    for (Py_ssize_t i = 0; i < size; ++i) {
...
{
  /* NOTE(esteve): Call constructor of TestSubArray */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_babel_fish_test_msgs.msg._test_sub_array");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TestSubArray");
  ...
  ros_babel_fish_test_msgs__msg__TestSubArray * ros_message = (ros_babel_fish_test_msgs__msg__TestSubArray *)raw_ros_message;
  {  // ints
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "ints");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    if (ros_message->ints.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      int32_t * src = &(ros_message->ints.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->ints.size * sizeof(int32_t));
      assert(data != NULL);
