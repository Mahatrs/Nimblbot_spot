...
static const _ManagerLaunch_type_support_symbol_names_t _ManagerLaunch_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rviz_manager_msgs, msg, ManagerLaunch)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rviz_manager_msgs, msg, ManagerLaunch)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rviz_manager_msgs, msg, ManagerLaunch)() {
  return &::rviz_manager_msgs::msg::rosidl_typesupport_c::ManagerLaunch_message_type_support_handle;
}
