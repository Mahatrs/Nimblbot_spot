...
bool rviz_manager_msgs__msg__manager_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rviz_manager_msgs.msg._manager_status.ManagerStatus", full_classname_dest, 51) == 0);
  }
  rviz_manager_msgs__msg__ManagerStatus * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of ManagerStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rviz_manager_msgs.msg._manager_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ManagerStatus");
