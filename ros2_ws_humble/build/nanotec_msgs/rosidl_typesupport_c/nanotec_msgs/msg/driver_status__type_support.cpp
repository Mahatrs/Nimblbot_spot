...
static const _DriverStatus_type_support_symbol_names_t _DriverStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, nanotec_msgs, msg, DriverStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nanotec_msgs, msg, DriverStatus)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, nanotec_msgs, msg, DriverStatus)() {
  return &::nanotec_msgs::msg::rosidl_typesupport_c::DriverStatus_message_type_support_handle;
}
