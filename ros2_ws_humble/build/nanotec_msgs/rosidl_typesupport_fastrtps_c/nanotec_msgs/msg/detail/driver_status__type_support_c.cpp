...
#include "nanotec_msgs/msg/detail/driver_status__rosidl_typesupport_fastrtps_c.h"
...
#include "nanotec_msgs/msg/detail/device_status__functions.h"  // devices
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_nanotec_msgs
...
using _DriverStatus__ros_msg_type = nanotec_msgs__msg__DriverStatus;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: devices
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, nanotec_msgs, msg, DeviceStatus
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: devices
  {
    ...
    if (ros_message->devices.data) {
      nanotec_msgs__msg__DeviceStatus__Sequence__fini(&ros_message->devices);
    }
    if (!nanotec_msgs__msg__DeviceStatus__Sequence__init(&ros_message->devices, size)) {
...
size_t get_serialized_size_nanotec_msgs__msg__DriverStatus(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _DriverStatus__ros_msg_type * ros_message = static_cast<const _DriverStatus__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name devices
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_nanotec_msgs__msg__DeviceStatus(
...
static uint32_t _DriverStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_nanotec_msgs__msg__DriverStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nanotec_msgs
size_t max_serialized_size_nanotec_msgs__msg__DriverStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: devices
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_nanotec_msgs__msg__DeviceStatus(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = nanotec_msgs__msg__DriverStatus;
    is_plain =
      (
...
static size_t _DriverStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_nanotec_msgs__msg__DriverStatus(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, nanotec_msgs, msg, DriverStatus)() {
