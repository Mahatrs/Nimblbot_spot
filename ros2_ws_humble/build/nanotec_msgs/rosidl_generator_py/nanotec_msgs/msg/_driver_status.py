...
class Metaclass_DriverStatus(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from nanotec_msgs.msg import DeviceStatus
            if DeviceStatus.__class__._TYPE_SUPPORT is None:
                DeviceStatus.__class__.__import_type_support__()
...
class DriverStatus(metaclass=Metaclass_DriverStatus):
    ...
    _fields_and_field_types = {
        ...
        'devices': 'sequence<nanotec_msgs/DeviceStatus>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['nanotec_msgs', 'msg'], 'DeviceStatus')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, DeviceStatus) for v in value) and
                 True), \
                "The 'devices' field must be a set or sequence and each value of type 'DeviceStatus'"
        self._devices = value
