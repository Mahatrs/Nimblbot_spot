...
#include "nanotec_msgs/msg/detail/driver_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const nanotec_msgs::msg::DeviceStatus &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const nanotec_msgs::msg::DriverStatus & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: devices
  {
    ...
    for (size_t i = 0; i < size; i++) {
      nanotec_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  nanotec_msgs::msg::DriverStatus & ros_message)
{
  // Member: header
  ...
  // Member: devices
  {
    ...
    for (size_t i = 0; i < size; i++) {
      nanotec_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: devices
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        nanotec_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: devices
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        nanotec_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_DeviceStatus(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = nanotec_msgs::msg::DriverStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const nanotec_msgs::msg::DriverStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<nanotec_msgs::msg::DriverStatus *>(
    untyped_ros_message);
...
{
  return &nanotec_msgs::msg::typesupport_fastrtps_cpp::_DriverStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nanotec_msgs, msg, DriverStatus)() {
  return &nanotec_msgs::msg::typesupport_fastrtps_cpp::_DriverStatus__handle;
}
