...
static const _DriverStatus_type_support_symbol_names_t _DriverStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nanotec_msgs, msg, DriverStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, nanotec_msgs, msg, DriverStatus)),
  }
};
...
{
  return &::nanotec_msgs::msg::rosidl_typesupport_cpp::DriverStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, nanotec_msgs, msg, DriverStatus)() {
  return get_message_type_support_handle<nanotec_msgs::msg::DriverStatus>();
}
