...
// Include directives for member types
// Member 'result'
#include "bosdyn_api_msgs/msg/detail/robot_command_feedback__struct.h"
// Member 'message'
...
{
  bosdyn_api_msgs__msg__RobotCommandFeedback result;
  bool success;
...
{
  bosdyn_api_msgs__msg__RobotCommandFeedback feedback;
