...
// Member 'command'
#include "bosdyn_api_msgs/msg/detail/manipulation_api_request__struct.h"

/// Struct defined in action/Manipulation in the package spot_msgs.
typedef struct spot_msgs__action__Manipulation_Goal
{
  bosdyn_api_msgs__msg__ManipulationApiRequest command;
...
// Include directives for member types
// Member 'result'
#include "bosdyn_api_msgs/msg/detail/manipulation_api_feedback_response__struct.h"
// Member 'message'
...
{
  bosdyn_api_msgs__msg__ManipulationApiFeedbackResponse result;
  bool success;
...
{
  bosdyn_api_msgs__msg__ManipulationApiFeedbackResponse feedback;
