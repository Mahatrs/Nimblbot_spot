...
// Member `command`
#include "bosdyn_api_msgs/msg/detail/robot_command__functions.h"
...
spot_msgs__action__RobotCommand_Goal__init(spot_msgs__action__RobotCommand_Goal * msg)
{
  ...
  // command
  if (!bosdyn_api_msgs__msg__RobotCommand__init(&msg->command)) {
    spot_msgs__action__RobotCommand_Goal__fini(msg);
    return false;
  }
  return true;
}
...
spot_msgs__action__RobotCommand_Goal__fini(spot_msgs__action__RobotCommand_Goal * msg)
{
  ...
  // command
  bosdyn_api_msgs__msg__RobotCommand__fini(&msg->command);
}
...
spot_msgs__action__RobotCommand_Goal__are_equal(const spot_msgs__action__RobotCommand_Goal * lhs, const spot_msgs__action__RobotCommand_Goal * rhs)
{
  ...
  // command
  if (!bosdyn_api_msgs__msg__RobotCommand__are_equal(
  ...
  spot_msgs__action__RobotCommand_Goal * output)
{
  ...
  // command
  if (!bosdyn_api_msgs__msg__RobotCommand__copy(
...
spot_msgs__action__RobotCommand_Goal__create()
{
  ...
  spot_msgs__action__RobotCommand_Goal * msg = (spot_msgs__action__RobotCommand_Goal *)allocator.allocate(sizeof(spot_msgs__action__RobotCommand_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(spot_msgs__action__RobotCommand_Goal));
  bool success = spot_msgs__action__RobotCommand_Goal__init(msg);
  if (!success) {
...
spot_msgs__action__RobotCommand_Goal__Sequence__init(spot_msgs__action__RobotCommand_Goal__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  spot_msgs__action__RobotCommand_Goal * data = NULL;

  if (size) {
    data = (spot_msgs__action__RobotCommand_Goal *)allocator.zero_allocate(size, sizeof(spot_msgs__action__RobotCommand_Goal), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = spot_msgs__action__RobotCommand_Goal__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        spot_msgs__action__RobotCommand_Goal__fini(&data[i - 1]);
      }
...
spot_msgs__action__RobotCommand_Goal__Sequence__fini(spot_msgs__action__RobotCommand_Goal__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      spot_msgs__action__RobotCommand_Goal__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  spot_msgs__action__RobotCommand_Goal__Sequence * array = (spot_msgs__action__RobotCommand_Goal__Sequence *)allocator.allocate(sizeof(spot_msgs__action__RobotCommand_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = spot_msgs__action__RobotCommand_Goal__Sequence__init(array, size);
  if (!success) {
...
spot_msgs__action__RobotCommand_Goal__Sequence__destroy(spot_msgs__action__RobotCommand_Goal__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    spot_msgs__action__RobotCommand_Goal__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
spot_msgs__action__RobotCommand_Goal__Sequence__are_equal(const spot_msgs__action__RobotCommand_Goal__Sequence * lhs, const spot_msgs__action__RobotCommand_Goal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!spot_msgs__action__RobotCommand_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  spot_msgs__action__RobotCommand_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(spot_msgs__action__RobotCommand_Goal);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    spot_msgs__action__RobotCommand_Goal * data =
      (spot_msgs__action__RobotCommand_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!spot_msgs__action__RobotCommand_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          spot_msgs__action__RobotCommand_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!spot_msgs__action__RobotCommand_Goal__copy(
...
// Include directives for member types
// Member `result`
#include "bosdyn_api_msgs/msg/detail/robot_command_feedback__functions.h"
// Member `message`
...
spot_msgs__action__RobotCommand_Result__init(spot_msgs__action__RobotCommand_Result * msg)
{
  ...
  // result
  if (!bosdyn_api_msgs__msg__RobotCommandFeedback__init(&msg->result)) {
    spot_msgs__action__RobotCommand_Result__fini(msg);
    return false;
  }
  // success
  // message
...
spot_msgs__action__RobotCommand_Result__fini(spot_msgs__action__RobotCommand_Result * msg)
{
  ...
  // result
  bosdyn_api_msgs__msg__RobotCommandFeedback__fini(&msg->result);
  // success
  // message
...
spot_msgs__action__RobotCommand_Result__are_equal(const spot_msgs__action__RobotCommand_Result * lhs, const spot_msgs__action__RobotCommand_Result * rhs)
{
  ...
  // result
  if (!bosdyn_api_msgs__msg__RobotCommandFeedback__are_equal(
  ...
  spot_msgs__action__RobotCommand_Result * output)
{
  ...
  // result
  if (!bosdyn_api_msgs__msg__RobotCommandFeedback__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  spot_msgs__action__RobotCommand_Result * msg = (spot_msgs__action__RobotCommand_Result *)allocator.allocate(sizeof(spot_msgs__action__RobotCommand_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(spot_msgs__action__RobotCommand_Result));
  bool success = spot_msgs__action__RobotCommand_Result__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
spot_msgs__action__RobotCommand_Result__Sequence__init(spot_msgs__action__RobotCommand_Result__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  spot_msgs__action__RobotCommand_Result * data = NULL;

  if (size) {
    data = (spot_msgs__action__RobotCommand_Result *)allocator.zero_allocate(size, sizeof(spot_msgs__action__RobotCommand_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = spot_msgs__action__RobotCommand_Result__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        spot_msgs__action__RobotCommand_Result__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
spot_msgs__action__RobotCommand_Result__Sequence__fini(spot_msgs__action__RobotCommand_Result__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      spot_msgs__action__RobotCommand_Result__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  spot_msgs__action__RobotCommand_Result__Sequence * array = (spot_msgs__action__RobotCommand_Result__Sequence *)allocator.allocate(sizeof(spot_msgs__action__RobotCommand_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = spot_msgs__action__RobotCommand_Result__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
spot_msgs__action__RobotCommand_Result__Sequence__destroy(spot_msgs__action__RobotCommand_Result__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    spot_msgs__action__RobotCommand_Result__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
spot_msgs__action__RobotCommand_Result__Sequence__are_equal(const spot_msgs__action__RobotCommand_Result__Sequence * lhs, const spot_msgs__action__RobotCommand_Result__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!spot_msgs__action__RobotCommand_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  spot_msgs__action__RobotCommand_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(spot_msgs__action__RobotCommand_Result);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    spot_msgs__action__RobotCommand_Result * data =
      (spot_msgs__action__RobotCommand_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!spot_msgs__action__RobotCommand_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          spot_msgs__action__RobotCommand_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!spot_msgs__action__RobotCommand_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
spot_msgs__action__RobotCommand_Feedback__init(spot_msgs__action__RobotCommand_Feedback * msg)
{
  ...
  // feedback
  if (!bosdyn_api_msgs__msg__RobotCommandFeedback__init(&msg->feedback)) {
    spot_msgs__action__RobotCommand_Feedback__fini(msg);
    return false;
  }
  return true;
}
...
spot_msgs__action__RobotCommand_Feedback__fini(spot_msgs__action__RobotCommand_Feedback * msg)
{
  ...
  // feedback
  bosdyn_api_msgs__msg__RobotCommandFeedback__fini(&msg->feedback);
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  spot_msgs__action__RobotCommand_Feedback * msg = (spot_msgs__action__RobotCommand_Feedback *)allocator.allocate(sizeof(spot_msgs__action__RobotCommand_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(spot_msgs__action__RobotCommand_Feedback));
  bool success = spot_msgs__action__RobotCommand_Feedback__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
spot_msgs__action__RobotCommand_Feedback__Sequence__init(spot_msgs__action__RobotCommand_Feedback__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  spot_msgs__action__RobotCommand_Feedback * data = NULL;

  if (size) {
    data = (spot_msgs__action__RobotCommand_Feedback *)allocator.zero_allocate(size, sizeof(spot_msgs__action__RobotCommand_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = spot_msgs__action__RobotCommand_Feedback__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        spot_msgs__action__RobotCommand_Feedback__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
spot_msgs__action__RobotCommand_Feedback__Sequence__fini(spot_msgs__action__RobotCommand_Feedback__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      spot_msgs__action__RobotCommand_Feedback__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  spot_msgs__action__RobotCommand_Feedback__Sequence * array = (spot_msgs__action__RobotCommand_Feedback__Sequence *)allocator.allocate(sizeof(spot_msgs__action__RobotCommand_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = spot_msgs__action__RobotCommand_Feedback__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
spot_msgs__action__RobotCommand_Feedback__Sequence__destroy(spot_msgs__action__RobotCommand_Feedback__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    spot_msgs__action__RobotCommand_Feedback__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
spot_msgs__action__RobotCommand_Feedback__Sequence__are_equal(const spot_msgs__action__RobotCommand_Feedback__Sequence * lhs, const spot_msgs__action__RobotCommand_Feedback__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!spot_msgs__action__RobotCommand_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  spot_msgs__action__RobotCommand_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(spot_msgs__action__RobotCommand_Feedback);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    spot_msgs__action__RobotCommand_Feedback * data =
      (spot_msgs__action__RobotCommand_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!spot_msgs__action__RobotCommand_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          spot_msgs__action__RobotCommand_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!spot_msgs__action__RobotCommand_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
spot_msgs__action__RobotCommand_SendGoal_Request__init(spot_msgs__action__RobotCommand_SendGoal_Request * msg)
{
  ...
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    spot_msgs__action__RobotCommand_SendGoal_Request__fini(msg);
    return false;
  }
  // goal
  if (!spot_msgs__action__RobotCommand_Goal__init(&msg->goal)) {
    spot_msgs__action__RobotCommand_SendGoal_Request__fini(msg);
    return false;
  }
  return true;
...
spot_msgs__action__RobotCommand_SendGoal_Request__fini(spot_msgs__action__RobotCommand_SendGoal_Request * msg)
{
  ...
  // goal
  spot_msgs__action__RobotCommand_Goal__fini(&msg->goal);
}
...
spot_msgs__action__RobotCommand_SendGoal_Request__are_equal(const spot_msgs__action__RobotCommand_SendGoal_Request * lhs, const spot_msgs__action__RobotCommand_SendGoal_Request * rhs)
{
  ...
  // goal
  if (!spot_msgs__action__RobotCommand_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  spot_msgs__action__RobotCommand_SendGoal_Request * msg = (spot_msgs__action__RobotCommand_SendGoal_Request *)allocator.allocate(sizeof(spot_msgs__action__RobotCommand_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(spot_msgs__action__RobotCommand_SendGoal_Request));
  bool success = spot_msgs__action__RobotCommand_SendGoal_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
spot_msgs__action__RobotCommand_SendGoal_Request__Sequence__init(spot_msgs__action__RobotCommand_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  spot_msgs__action__RobotCommand_SendGoal_Request * data = NULL;

  if (size) {
    data = (spot_msgs__action__RobotCommand_SendGoal_Request *)allocator.zero_allocate(size, sizeof(spot_msgs__action__RobotCommand_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = spot_msgs__action__RobotCommand_SendGoal_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        spot_msgs__action__RobotCommand_SendGoal_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
spot_msgs__action__RobotCommand_SendGoal_Request__Sequence__fini(spot_msgs__action__RobotCommand_SendGoal_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      spot_msgs__action__RobotCommand_SendGoal_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  spot_msgs__action__RobotCommand_SendGoal_Request__Sequence * array = (spot_msgs__action__RobotCommand_SendGoal_Request__Sequence *)allocator.allocate(sizeof(spot_msgs__action__RobotCommand_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = spot_msgs__action__RobotCommand_SendGoal_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
spot_msgs__action__RobotCommand_SendGoal_Request__Sequence__destroy(spot_msgs__action__RobotCommand_SendGoal_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    spot_msgs__action__RobotCommand_SendGoal_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
spot_msgs__action__RobotCommand_SendGoal_Request__Sequence__are_equal(const spot_msgs__action__RobotCommand_SendGoal_Request__Sequence * lhs, const spot_msgs__action__RobotCommand_SendGoal_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!spot_msgs__action__RobotCommand_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  spot_msgs__action__RobotCommand_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(spot_msgs__action__RobotCommand_SendGoal_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    spot_msgs__action__RobotCommand_SendGoal_Request * data =
      (spot_msgs__action__RobotCommand_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!spot_msgs__action__RobotCommand_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          spot_msgs__action__RobotCommand_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!spot_msgs__action__RobotCommand_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
spot_msgs__action__RobotCommand_SendGoal_Response__init(spot_msgs__action__RobotCommand_SendGoal_Response * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    spot_msgs__action__RobotCommand_SendGoal_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  spot_msgs__action__RobotCommand_SendGoal_Response * msg = (spot_msgs__action__RobotCommand_SendGoal_Response *)allocator.allocate(sizeof(spot_msgs__action__RobotCommand_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(spot_msgs__action__RobotCommand_SendGoal_Response));
  bool success = spot_msgs__action__RobotCommand_SendGoal_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
spot_msgs__action__RobotCommand_SendGoal_Response__Sequence__init(spot_msgs__action__RobotCommand_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  spot_msgs__action__RobotCommand_SendGoal_Response * data = NULL;

  if (size) {
    data = (spot_msgs__action__RobotCommand_SendGoal_Response *)allocator.zero_allocate(size, sizeof(spot_msgs__action__RobotCommand_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = spot_msgs__action__RobotCommand_SendGoal_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        spot_msgs__action__RobotCommand_SendGoal_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
spot_msgs__action__RobotCommand_SendGoal_Response__Sequence__fini(spot_msgs__action__RobotCommand_SendGoal_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      spot_msgs__action__RobotCommand_SendGoal_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  spot_msgs__action__RobotCommand_SendGoal_Response__Sequence * array = (spot_msgs__action__RobotCommand_SendGoal_Response__Sequence *)allocator.allocate(sizeof(spot_msgs__action__RobotCommand_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = spot_msgs__action__RobotCommand_SendGoal_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
spot_msgs__action__RobotCommand_SendGoal_Response__Sequence__destroy(spot_msgs__action__RobotCommand_SendGoal_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    spot_msgs__action__RobotCommand_SendGoal_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
spot_msgs__action__RobotCommand_SendGoal_Response__Sequence__are_equal(const spot_msgs__action__RobotCommand_SendGoal_Response__Sequence * lhs, const spot_msgs__action__RobotCommand_SendGoal_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!spot_msgs__action__RobotCommand_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  spot_msgs__action__RobotCommand_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(spot_msgs__action__RobotCommand_SendGoal_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    spot_msgs__action__RobotCommand_SendGoal_Response * data =
      (spot_msgs__action__RobotCommand_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!spot_msgs__action__RobotCommand_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          spot_msgs__action__RobotCommand_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!spot_msgs__action__RobotCommand_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
spot_msgs__action__RobotCommand_GetResult_Request__init(spot_msgs__action__RobotCommand_GetResult_Request * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    spot_msgs__action__RobotCommand_GetResult_Request__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  spot_msgs__action__RobotCommand_GetResult_Request * msg = (spot_msgs__action__RobotCommand_GetResult_Request *)allocator.allocate(sizeof(spot_msgs__action__RobotCommand_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(spot_msgs__action__RobotCommand_GetResult_Request));
  bool success = spot_msgs__action__RobotCommand_GetResult_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
spot_msgs__action__RobotCommand_GetResult_Request__Sequence__init(spot_msgs__action__RobotCommand_GetResult_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  spot_msgs__action__RobotCommand_GetResult_Request * data = NULL;

  if (size) {
    data = (spot_msgs__action__RobotCommand_GetResult_Request *)allocator.zero_allocate(size, sizeof(spot_msgs__action__RobotCommand_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = spot_msgs__action__RobotCommand_GetResult_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        spot_msgs__action__RobotCommand_GetResult_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
spot_msgs__action__RobotCommand_GetResult_Request__Sequence__fini(spot_msgs__action__RobotCommand_GetResult_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      spot_msgs__action__RobotCommand_GetResult_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  spot_msgs__action__RobotCommand_GetResult_Request__Sequence * array = (spot_msgs__action__RobotCommand_GetResult_Request__Sequence *)allocator.allocate(sizeof(spot_msgs__action__RobotCommand_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = spot_msgs__action__RobotCommand_GetResult_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
spot_msgs__action__RobotCommand_GetResult_Request__Sequence__destroy(spot_msgs__action__RobotCommand_GetResult_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    spot_msgs__action__RobotCommand_GetResult_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
spot_msgs__action__RobotCommand_GetResult_Request__Sequence__are_equal(const spot_msgs__action__RobotCommand_GetResult_Request__Sequence * lhs, const spot_msgs__action__RobotCommand_GetResult_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!spot_msgs__action__RobotCommand_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  spot_msgs__action__RobotCommand_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(spot_msgs__action__RobotCommand_GetResult_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    spot_msgs__action__RobotCommand_GetResult_Request * data =
      (spot_msgs__action__RobotCommand_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!spot_msgs__action__RobotCommand_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          spot_msgs__action__RobotCommand_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!spot_msgs__action__RobotCommand_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
spot_msgs__action__RobotCommand_GetResult_Response__init(spot_msgs__action__RobotCommand_GetResult_Response * msg)
{
  ...
  // status
  // result
  if (!spot_msgs__action__RobotCommand_Result__init(&msg->result)) {
    spot_msgs__action__RobotCommand_GetResult_Response__fini(msg);
    return false;
  }
  return true;
}
...
spot_msgs__action__RobotCommand_GetResult_Response__fini(spot_msgs__action__RobotCommand_GetResult_Response * msg)
{
  ...
  // status
  // result
  spot_msgs__action__RobotCommand_Result__fini(&msg->result);
}
...
spot_msgs__action__RobotCommand_GetResult_Response__are_equal(const spot_msgs__action__RobotCommand_GetResult_Response * lhs, const spot_msgs__action__RobotCommand_GetResult_Response * rhs)
{
  ...
  // result
  if (!spot_msgs__action__RobotCommand_Result__are_equal(
      &(lhs->result), &(rhs->result)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  spot_msgs__action__RobotCommand_GetResult_Response * msg = (spot_msgs__action__RobotCommand_GetResult_Response *)allocator.allocate(sizeof(spot_msgs__action__RobotCommand_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(spot_msgs__action__RobotCommand_GetResult_Response));
  bool success = spot_msgs__action__RobotCommand_GetResult_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
spot_msgs__action__RobotCommand_GetResult_Response__Sequence__init(spot_msgs__action__RobotCommand_GetResult_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  spot_msgs__action__RobotCommand_GetResult_Response * data = NULL;

  if (size) {
    data = (spot_msgs__action__RobotCommand_GetResult_Response *)allocator.zero_allocate(size, sizeof(spot_msgs__action__RobotCommand_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = spot_msgs__action__RobotCommand_GetResult_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        spot_msgs__action__RobotCommand_GetResult_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
spot_msgs__action__RobotCommand_GetResult_Response__Sequence__fini(spot_msgs__action__RobotCommand_GetResult_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      spot_msgs__action__RobotCommand_GetResult_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  spot_msgs__action__RobotCommand_GetResult_Response__Sequence * array = (spot_msgs__action__RobotCommand_GetResult_Response__Sequence *)allocator.allocate(sizeof(spot_msgs__action__RobotCommand_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = spot_msgs__action__RobotCommand_GetResult_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
spot_msgs__action__RobotCommand_GetResult_Response__Sequence__destroy(spot_msgs__action__RobotCommand_GetResult_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    spot_msgs__action__RobotCommand_GetResult_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
spot_msgs__action__RobotCommand_GetResult_Response__Sequence__are_equal(const spot_msgs__action__RobotCommand_GetResult_Response__Sequence * lhs, const spot_msgs__action__RobotCommand_GetResult_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!spot_msgs__action__RobotCommand_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  spot_msgs__action__RobotCommand_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(spot_msgs__action__RobotCommand_GetResult_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    spot_msgs__action__RobotCommand_GetResult_Response * data =
      (spot_msgs__action__RobotCommand_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!spot_msgs__action__RobotCommand_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          spot_msgs__action__RobotCommand_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!spot_msgs__action__RobotCommand_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
spot_msgs__action__RobotCommand_FeedbackMessage__init(spot_msgs__action__RobotCommand_FeedbackMessage * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    spot_msgs__action__RobotCommand_FeedbackMessage__fini(msg);
    return false;
  }
  // feedback
  if (!spot_msgs__action__RobotCommand_Feedback__init(&msg->feedback)) {
    spot_msgs__action__RobotCommand_FeedbackMessage__fini(msg);
    return false;
  }
  return true;
...
spot_msgs__action__RobotCommand_FeedbackMessage__fini(spot_msgs__action__RobotCommand_FeedbackMessage * msg)
{
  ...
  unique_identifier_msgs__msg__UUID__fini(&msg->goal_id);
  // feedback
  spot_msgs__action__RobotCommand_Feedback__fini(&msg->feedback);
}
...
spot_msgs__action__RobotCommand_FeedbackMessage__are_equal(const spot_msgs__action__RobotCommand_FeedbackMessage * lhs, const spot_msgs__action__RobotCommand_FeedbackMessage * rhs)
{
  ...
  // feedback
  if (!spot_msgs__action__RobotCommand_Feedback__are_equal(
      &(lhs->feedback), &(rhs->feedback)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  spot_msgs__action__RobotCommand_FeedbackMessage * msg = (spot_msgs__action__RobotCommand_FeedbackMessage *)allocator.allocate(sizeof(spot_msgs__action__RobotCommand_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(spot_msgs__action__RobotCommand_FeedbackMessage));
  bool success = spot_msgs__action__RobotCommand_FeedbackMessage__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
spot_msgs__action__RobotCommand_FeedbackMessage__Sequence__init(spot_msgs__action__RobotCommand_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  spot_msgs__action__RobotCommand_FeedbackMessage * data = NULL;

  if (size) {
    data = (spot_msgs__action__RobotCommand_FeedbackMessage *)allocator.zero_allocate(size, sizeof(spot_msgs__action__RobotCommand_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = spot_msgs__action__RobotCommand_FeedbackMessage__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        spot_msgs__action__RobotCommand_FeedbackMessage__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
spot_msgs__action__RobotCommand_FeedbackMessage__Sequence__fini(spot_msgs__action__RobotCommand_FeedbackMessage__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      spot_msgs__action__RobotCommand_FeedbackMessage__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  spot_msgs__action__RobotCommand_FeedbackMessage__Sequence * array = (spot_msgs__action__RobotCommand_FeedbackMessage__Sequence *)allocator.allocate(sizeof(spot_msgs__action__RobotCommand_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = spot_msgs__action__RobotCommand_FeedbackMessage__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
spot_msgs__action__RobotCommand_FeedbackMessage__Sequence__destroy(spot_msgs__action__RobotCommand_FeedbackMessage__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    spot_msgs__action__RobotCommand_FeedbackMessage__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
spot_msgs__action__RobotCommand_FeedbackMessage__Sequence__are_equal(const spot_msgs__action__RobotCommand_FeedbackMessage__Sequence * lhs, const spot_msgs__action__RobotCommand_FeedbackMessage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!spot_msgs__action__RobotCommand_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  spot_msgs__action__RobotCommand_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(spot_msgs__action__RobotCommand_FeedbackMessage);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    spot_msgs__action__RobotCommand_FeedbackMessage * data =
      (spot_msgs__action__RobotCommand_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!spot_msgs__action__RobotCommand_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          spot_msgs__action__RobotCommand_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!spot_msgs__action__RobotCommand_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
