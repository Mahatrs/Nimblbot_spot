...
// Member 'request'
#include "bosdyn_api_msgs/msg/detail/list_world_object_request__struct.h"

/// Struct defined in srv/ListWorldObjects in the package spot_msgs.
typedef struct spot_msgs__srv__ListWorldObjects_Request
{
  bosdyn_api_msgs__msg__ListWorldObjectRequest request;
...
// Include directives for member types
// Member 'response'
#include "bosdyn_api_msgs/msg/detail/list_world_object_response__struct.h"

/// Struct defined in srv/ListWorldObjects in the package spot_msgs.
typedef struct spot_msgs__srv__ListWorldObjects_Response
{
  bosdyn_api_msgs__msg__ListWorldObjectResponse response;
