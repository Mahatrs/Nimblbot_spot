...
// Member 'request'
#include "bosdyn_api_msgs/msg/detail/gripper_camera_param_request__struct.h"
...
{
  bosdyn_api_msgs__msg__GripperCameraParamRequest request;
...
// Include directives for member types
// Member 'response'
#include "bosdyn_api_msgs/msg/detail/gripper_camera_param_response__struct.h"
// Member 'message'
...
{
  bosdyn_api_msgs__msg__GripperCameraParamResponse response;
  bool success;
