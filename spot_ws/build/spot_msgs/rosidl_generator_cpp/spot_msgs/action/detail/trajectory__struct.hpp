...
struct Trajectory_Goal_
{
    ...
    duration(_init)
  {
    ...
    {
      this->disable_obstacle_avoidance = false;
  ...
  using _disable_obstacle_avoidance_type =
    bool;
  _disable_obstacle_avoidance_type disable_obstacle_avoidance;
  ...
  Type & set__disable_obstacle_avoidance(
    const bool & _arg)
  {
    this->disable_obstacle_avoidance = _arg;
    return *this;
  }
  ...
  bool operator==(const Trajectory_Goal_ & other) const
  {
    ...
    if (this->disable_obstacle_avoidance != other.disable_obstacle_avoidance) {
      return false;
    }
    return true;
  }
