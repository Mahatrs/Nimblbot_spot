...
// Include directives for member types
// Member 'result'
#include "bosdyn_api_msgs/msg/detail/robot_command_feedback__struct.hpp"
...
struct RobotCommand_Result_
{
  ...
  // field types and members
  using _result_type =
    bosdyn_api_msgs::msg::RobotCommandFeedback_<ContainerAllocator>;
  _result_type result;
  using _success_type =
    bool;
  ...
  // setters for named parameter idiom
  Type & set__result(
    const bosdyn_api_msgs::msg::RobotCommandFeedback_<ContainerAllocator> & _arg)
  {
    this->result = _arg;
    return *this;
  }
