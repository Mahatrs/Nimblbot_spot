...
struct has_fixed_size<spot_msgs::action::RobotCommand_Goal>
  : std::integral_constant<bool, has_fixed_size<bosdyn_api_msgs::msg::RobotCommand>::value> {};

template<>
struct has_bounded_size<spot_msgs::action::RobotCommand_Goal>
  : std::integral_constant<bool, has_bounded_size<bosdyn_api_msgs::msg::RobotCommand>::value> {};
...
// Include directives for member types
// Member 'result'
#include "bosdyn_api_msgs/msg/detail/robot_command_feedback__traits.hpp"
...
struct has_fixed_size<spot_msgs::action::RobotCommand_Feedback>
  : std::integral_constant<bool, has_fixed_size<bosdyn_api_msgs::msg::RobotCommandFeedback>::value> {};

template<>
struct has_bounded_size<spot_msgs::action::RobotCommand_Feedback>
  : std::integral_constant<bool, has_bounded_size<bosdyn_api_msgs::msg::RobotCommandFeedback>::value> {};
