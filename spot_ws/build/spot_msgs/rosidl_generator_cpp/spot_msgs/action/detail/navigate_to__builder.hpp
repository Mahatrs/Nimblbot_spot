...
class Init_NavigateTo_Goal_waypoint_id
{
public:
  Init_NavigateTo_Goal_waypoint_id()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::spot_msgs::action::NavigateTo_Goal waypoint_id(::spot_msgs::action::NavigateTo_Goal::_waypoint_id_type arg)
  {
...
{
  return spot_msgs::action::builder::Init_NavigateTo_Goal_waypoint_id();
}
