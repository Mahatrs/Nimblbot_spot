...
class Init_Trajectory_Goal_disable_obstacle_avoidance
{
public:
  explicit Init_Trajectory_Goal_disable_obstacle_avoidance(::spot_msgs::action::Trajectory_Goal & msg)
  : msg_(msg)
  {}
  ::spot_msgs::action::Trajectory_Goal disable_obstacle_avoidance(::spot_msgs::action::Trajectory_Goal::_disable_obstacle_avoidance_type arg)
  {
    msg_.disable_obstacle_avoidance = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_Trajectory_Goal_disable_obstacle_avoidance precise_positioning(::spot_msgs::action::Trajectory_Goal::_precise_positioning_type arg)
  {
    msg_.precise_positioning = std::move(arg);
    return Init_Trajectory_Goal_disable_obstacle_avoidance(msg_);
  }
