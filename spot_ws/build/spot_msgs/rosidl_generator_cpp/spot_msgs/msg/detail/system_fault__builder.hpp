...
class Init_SystemFault_uuid
{
public:
  explicit Init_SystemFault_uuid(::spot_msgs::msg::SystemFault & msg)
  : msg_(msg)
  {}
  Init_SystemFault_error_message uuid(::spot_msgs::msg::SystemFault::_uuid_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_SystemFault_uuid code(::spot_msgs::msg::SystemFault::_code_type arg)
  {
    msg_.code = std::move(arg);
    return Init_SystemFault_uuid(msg_);
  }
