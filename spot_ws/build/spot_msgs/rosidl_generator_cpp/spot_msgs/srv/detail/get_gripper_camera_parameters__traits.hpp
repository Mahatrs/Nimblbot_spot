...
// Member 'request'
#include "bosdyn_api_msgs/msg/detail/gripper_camera_get_param_request__traits.hpp"
...
struct has_fixed_size<spot_msgs::srv::GetGripperCameraParameters_Request>
  : std::integral_constant<bool, has_fixed_size<bosdyn_api_msgs::msg::GripperCameraGetParamRequest>::value> {};

template<>
struct has_bounded_size<spot_msgs::srv::GetGripperCameraParameters_Request>
  : std::integral_constant<bool, has_bounded_size<bosdyn_api_msgs::msg::GripperCameraGetParamRequest>::value> {};
...
// Include directives for member types
// Member 'response'
#include "bosdyn_api_msgs/msg/detail/gripper_camera_get_param_response__traits.hpp"
