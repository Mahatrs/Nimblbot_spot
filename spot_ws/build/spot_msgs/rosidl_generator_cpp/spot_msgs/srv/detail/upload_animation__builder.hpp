...
class Init_UploadAnimation_Request_animation_proto_serialized
{
public:
  explicit Init_UploadAnimation_Request_animation_proto_serialized(::spot_msgs::srv::UploadAnimation_Request & msg)
  : msg_(msg)
  {}
  ::spot_msgs::srv::UploadAnimation_Request animation_proto_serialized(::spot_msgs::srv::UploadAnimation_Request::_animation_proto_serialized_type arg)
  {
    msg_.animation_proto_serialized = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_UploadAnimation_Request_animation_proto_serialized animation_file_content(::spot_msgs::srv::UploadAnimation_Request::_animation_file_content_type arg)
  {
    msg_.animation_file_content = std::move(arg);
    return Init_UploadAnimation_Request_animation_proto_serialized(msg_);
  }
