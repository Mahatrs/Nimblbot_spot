...
// Member 'request'
#include "bosdyn_api_msgs/msg/detail/list_world_object_request__struct.hpp"
...
struct ListWorldObjects_Request_
{
  ...
  using _request_type =
    bosdyn_api_msgs::msg::ListWorldObjectRequest_<ContainerAllocator>;
  _request_type request;

  // setters for named parameter idiom
  Type & set__request(
    const bosdyn_api_msgs::msg::ListWorldObjectRequest_<ContainerAllocator> & _arg)
  {
    this->request = _arg;
    return *this;
  }
...
// Include directives for member types
// Member 'response'
#include "bosdyn_api_msgs/msg/detail/list_world_object_response__struct.hpp"
...
struct ListWorldObjects_Response_
{
  ...
  using _response_type =
    bosdyn_api_msgs::msg::ListWorldObjectResponse_<ContainerAllocator>;
  _response_type response;

  // setters for named parameter idiom
  Type & set__response(
    const bosdyn_api_msgs::msg::ListWorldObjectResponse_<ContainerAllocator> & _arg)
  {
    this->response = _arg;
    return *this;
  }
