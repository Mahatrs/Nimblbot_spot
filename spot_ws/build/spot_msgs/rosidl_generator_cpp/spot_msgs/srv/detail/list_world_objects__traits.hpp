...
// Member 'request'
#include "bosdyn_api_msgs/msg/detail/list_world_object_request__traits.hpp"
...
struct has_fixed_size<spot_msgs::srv::ListWorldObjects_Request>
  : std::integral_constant<bool, has_fixed_size<bosdyn_api_msgs::msg::ListWorldObjectRequest>::value> {};

template<>
struct has_bounded_size<spot_msgs::srv::ListWorldObjects_Request>
  : std::integral_constant<bool, has_bounded_size<bosdyn_api_msgs::msg::ListWorldObjectRequest>::value> {};
...
// Include directives for member types
// Member 'response'
#include "bosdyn_api_msgs/msg/detail/list_world_object_response__traits.hpp"
...
struct has_fixed_size<spot_msgs::srv::ListWorldObjects_Response>
  : std::integral_constant<bool, has_fixed_size<bosdyn_api_msgs::msg::ListWorldObjectResponse>::value> {};

template<>
struct has_bounded_size<spot_msgs::srv::ListWorldObjects_Response>
  : std::integral_constant<bool, has_bounded_size<bosdyn_api_msgs::msg::ListWorldObjectResponse>::value> {};
