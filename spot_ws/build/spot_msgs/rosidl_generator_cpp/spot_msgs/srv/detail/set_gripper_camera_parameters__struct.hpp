...
// Member 'request'
#include "bosdyn_api_msgs/msg/detail/gripper_camera_param_request__struct.hpp"
...
struct SetGripperCameraParameters_Request_
{
  ...
  using _request_type =
    bosdyn_api_msgs::msg::GripperCameraParamRequest_<ContainerAllocator>;
  _request_type request;

  // setters for named parameter idiom
  Type & set__request(
    const bosdyn_api_msgs::msg::GripperCameraParamRequest_<ContainerAllocator> & _arg)
  {
    this->request = _arg;
    return *this;
  }
...
// Include directives for member types
// Member 'response'
#include "bosdyn_api_msgs/msg/detail/gripper_camera_param_response__struct.hpp"
...
struct SetGripperCameraParameters_Response_
{
  ...
  using _response_type =
    bosdyn_api_msgs::msg::GripperCameraParamResponse_<ContainerAllocator>;
  ...
  // setters for named parameter idiom
  Type & set__response(
    const bosdyn_api_msgs::msg::GripperCameraParamResponse_<ContainerAllocator> & _arg)
  {
    this->response = _arg;
    return *this;
  }
