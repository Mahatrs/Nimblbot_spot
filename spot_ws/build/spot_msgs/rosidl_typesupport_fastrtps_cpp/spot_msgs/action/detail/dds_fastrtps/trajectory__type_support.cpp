  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = spot_msgs::action::Trajectory_Goal;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = spot_msgs::action::Trajectory_Result;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = spot_msgs::action::Trajectory_Feedback;
    is_plain =
      (
...
// functions for spot_msgs::action::Trajectory_Goal already declared above
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = spot_msgs::action::Trajectory_SendGoal_Request;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = spot_msgs::action::Trajectory_SendGoal_Response;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = spot_msgs::action::Trajectory_GetResult_Request;
    is_plain =
      (
...
// forward declaration of message dependencies and their conversion functions
// functions for spot_msgs::action::Trajectory_Result already declared above
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = spot_msgs::action::Trajectory_GetResult_Response;
    is_plain =
      (
...
// functions for spot_msgs::action::Trajectory_Feedback already declared above
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = spot_msgs::action::Trajectory_FeedbackMessage;
    is_plain =
      (
      offsetof(DataType, feedback) +
      last_member_size
