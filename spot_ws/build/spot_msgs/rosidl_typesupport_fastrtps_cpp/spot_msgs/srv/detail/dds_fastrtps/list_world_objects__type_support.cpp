...
{
bool cdr_serialize(
  const bosdyn_api_msgs::msg::ListWorldObjectRequest &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  bosdyn_api_msgs::msg::ListWorldObjectRequest &);
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        bosdyn_api_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_ListWorldObjectRequest(
  ...
  if (is_plain) {
    ...
    using DataType = spot_msgs::srv::ListWorldObjects_Request;
    is_plain =
      (
...
{
bool cdr_serialize(
  const bosdyn_api_msgs::msg::ListWorldObjectResponse &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  bosdyn_api_msgs::msg::ListWorldObjectResponse &);
size_t get_serialized_size(
  const bosdyn_api_msgs::msg::ListWorldObjectResponse &,
  size_t current_alignment);
size_t
  ...
  size_t current_alignment)
{
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        bosdyn_api_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_ListWorldObjectResponse(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = spot_msgs::srv::ListWorldObjects_Response;
    is_plain =
      (
