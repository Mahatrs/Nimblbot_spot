...
#include "spot_msgs/srv/detail/robot_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const spot_msgs::srv::RobotCommand_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  spot_msgs::srv::RobotCommand_Request & ros_message)
{
  // Member: command
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = spot_msgs::srv::RobotCommand_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const spot_msgs::srv::RobotCommand_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<spot_msgs::srv::RobotCommand_Request *>(
    untyped_ros_message);
...
{
  return &spot_msgs::srv::typesupport_fastrtps_cpp::_RobotCommand_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, spot_msgs, srv, RobotCommand_Request)() {
  return &spot_msgs::srv::typesupport_fastrtps_cpp::_RobotCommand_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_spot_msgs
cdr_serialize(
  const spot_msgs::srv::RobotCommand_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  spot_msgs::srv::RobotCommand_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = spot_msgs::srv::RobotCommand_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const spot_msgs::srv::RobotCommand_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<spot_msgs::srv::RobotCommand_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &spot_msgs::srv::typesupport_fastrtps_cpp::_RobotCommand_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, spot_msgs, srv, RobotCommand_Response)() {
  return &spot_msgs::srv::typesupport_fastrtps_cpp::_RobotCommand_Response__handle;
}
...
{
  return &spot_msgs::srv::typesupport_fastrtps_cpp::_RobotCommand__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, spot_msgs, srv, RobotCommand)() {
  return &spot_msgs::srv::typesupport_fastrtps_cpp::_RobotCommand__handle;
}
