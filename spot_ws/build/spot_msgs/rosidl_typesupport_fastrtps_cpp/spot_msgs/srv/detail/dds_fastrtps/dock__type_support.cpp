...
#include "spot_msgs/srv/detail/dock__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const spot_msgs::srv::Dock_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  spot_msgs::srv::Dock_Request & ros_message)
{
  // Member: dock_id
  cdr >> ros_message.dock_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = spot_msgs::srv::Dock_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const spot_msgs::srv::Dock_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<spot_msgs::srv::Dock_Request *>(
    untyped_ros_message);
...
{
  return &spot_msgs::srv::typesupport_fastrtps_cpp::_Dock_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, spot_msgs, srv, Dock_Request)() {
  return &spot_msgs::srv::typesupport_fastrtps_cpp::_Dock_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_spot_msgs
cdr_serialize(
  const spot_msgs::srv::Dock_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  spot_msgs::srv::Dock_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = spot_msgs::srv::Dock_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const spot_msgs::srv::Dock_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<spot_msgs::srv::Dock_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &spot_msgs::srv::typesupport_fastrtps_cpp::_Dock_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, spot_msgs, srv, Dock_Response)() {
  return &spot_msgs::srv::typesupport_fastrtps_cpp::_Dock_Response__handle;
}
...
{
  return &spot_msgs::srv::typesupport_fastrtps_cpp::_Dock__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, spot_msgs, srv, Dock)() {
  return &spot_msgs::srv::typesupport_fastrtps_cpp::_Dock__handle;
}
