  ...
  size_t current_alignment)
{
  ...
  // Member: stairs_mode
  {
    size_t item_size = sizeof(ros_message.stairs_mode);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = spot_msgs::msg::MobilityParams;
    is_plain =
      (
...
static size_t _MobilityParams__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MobilityParams(full_bounded, is_plain, 0);
