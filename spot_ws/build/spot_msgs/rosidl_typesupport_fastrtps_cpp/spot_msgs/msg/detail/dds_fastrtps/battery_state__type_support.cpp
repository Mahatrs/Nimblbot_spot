...
#include "spot_msgs/msg/detail/battery_state__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = spot_msgs::msg::BatteryState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const spot_msgs::msg::BatteryState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<spot_msgs::msg::BatteryState *>(
    untyped_ros_message);
...
get_message_type_support_handle<spot_msgs::msg::BatteryState>()
{
  return &spot_msgs::msg::typesupport_fastrtps_cpp::_BatteryState__handle;
}
