...
static const _ListPtz_Request_type_support_symbol_names_t _ListPtz_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, spot_msgs, srv, ListPtz_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, spot_msgs, srv, ListPtz_Request)),
  }
};
...
{
  return &::spot_msgs::srv::rosidl_typesupport_cpp::ListPtz_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, spot_msgs, srv, ListPtz_Request)() {
  return get_message_type_support_handle<spot_msgs::srv::ListPtz_Request>();
}
...
static const _ListPtz_Response_type_support_symbol_names_t _ListPtz_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, spot_msgs, srv, ListPtz_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, spot_msgs, srv, ListPtz_Response)),
  }
};
...
{
  return &::spot_msgs::srv::rosidl_typesupport_cpp::ListPtz_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, spot_msgs, srv, ListPtz_Response)() {
  return get_message_type_support_handle<spot_msgs::srv::ListPtz_Response>();
}
...
static const _ListPtz_type_support_symbol_names_t _ListPtz_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, spot_msgs, srv, ListPtz)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, spot_msgs, srv, ListPtz)),
  }
};
...
{
  return &::spot_msgs::srv::rosidl_typesupport_cpp::ListPtz_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, spot_msgs, srv, ListPtz)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<spot_msgs::srv::ListPtz>();
}
