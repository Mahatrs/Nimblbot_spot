...
static const ::rosidl_typesupport_introspection_cpp::MessageMember NavigateTo_Goal_message_member_array[1] = {
  {
    "waypoint_id",  // name
    ...
    offsetof(spot_msgs::action::NavigateTo_Goal, waypoint_id),  // bytes offset in struct
