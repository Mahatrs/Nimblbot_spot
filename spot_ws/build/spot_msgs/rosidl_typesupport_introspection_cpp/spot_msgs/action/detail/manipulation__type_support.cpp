...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Manipulation_Goal_message_member_array[1] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<bosdyn_api_msgs::msg::ManipulationApiRequest>(),  // members of sub message
    false,  // is array
    0,  // array size
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Manipulation_Result_message_member_array[3] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<bosdyn_api_msgs::msg::ManipulationApiFeedbackResponse>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
