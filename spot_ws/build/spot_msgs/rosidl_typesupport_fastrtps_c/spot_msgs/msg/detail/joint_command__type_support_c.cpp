...
#include "spot_msgs/msg/detail/joint_command__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // effort, k_q_p, k_qd_p, position, velocity
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // effort, k_q_p, k_qd_p, position, velocity
...
using _JointCommand__ros_msg_type = spot_msgs__msg__JointCommand;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: k_q_p
  {
    size_t size = ros_message->k_q_p.size;
    auto array_ptr = ros_message->k_q_p.data;
    cdr << static_cast<uint32_t>(size);
    cdr.serializeArray(array_ptr, size);
  }
  ...
  // Field name: k_qd_p
  {
    size_t size = ros_message->k_qd_p.size;
    auto array_ptr = ros_message->k_qd_p.data;
    cdr << static_cast<uint32_t>(size);
    cdr.serializeArray(array_ptr, size);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: k_q_p
  {
    ...
    if (ros_message->k_q_p.data) {
      rosidl_runtime_c__double__Sequence__fini(&ros_message->k_q_p);
    }
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->k_q_p, size)) {
      fprintf(stderr, "failed to create array for field 'k_q_p'");
      return false;
    }
    auto array_ptr = ros_message->k_q_p.data;
    cdr.deserializeArray(array_ptr, size);
  ...
  // Field name: k_qd_p
  {
    ...
    if (ros_message->k_qd_p.data) {
      rosidl_runtime_c__double__Sequence__fini(&ros_message->k_qd_p);
    }
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->k_qd_p, size)) {
      fprintf(stderr, "failed to create array for field 'k_qd_p'");
      return false;
    }
    auto array_ptr = ros_message->k_qd_p.data;
    cdr.deserializeArray(array_ptr, size);
...
size_t get_serialized_size_spot_msgs__msg__JointCommand(
  const void * untyped_ros_message,
...
static uint32_t _JointCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_spot_msgs__msg__JointCommand(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_spot_msgs
size_t max_serialized_size_spot_msgs__msg__JointCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = spot_msgs__msg__JointCommand;
    is_plain =
      (
...
static size_t _JointCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_spot_msgs__msg__JointCommand(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, spot_msgs, msg, JointCommand)() {
