...
#include "rosidl_runtime_c/primitives_sequence.h"  // animation_proto_serialized
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // animation_proto_serialized
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: animation_proto_serialized
  {
    size_t size = ros_message->animation_proto_serialized.size;
    auto array_ptr = ros_message->animation_proto_serialized.data;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: animation_proto_serialized
  {
    ...
    if (ros_message->animation_proto_serialized.data) {
      rosidl_runtime_c__uint8__Sequence__fini(&ros_message->animation_proto_serialized);
    }
    if (!rosidl_runtime_c__uint8__Sequence__init(&ros_message->animation_proto_serialized, size)) {
      fprintf(stderr, "failed to create array for field 'animation_proto_serialized'");
      return false;
    }
    auto array_ptr = ros_message->animation_proto_serialized.data;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = spot_msgs__srv__UploadAnimation_Request;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = spot_msgs__srv__UploadAnimation_Response;
    is_plain =
      (
