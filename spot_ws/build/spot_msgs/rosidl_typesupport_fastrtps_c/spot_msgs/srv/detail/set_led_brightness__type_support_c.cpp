...
#include "spot_msgs/srv/detail/set_led_brightness__rosidl_typesupport_fastrtps_c.h"
...
using _SetLEDBrightness_Request__ros_msg_type = spot_msgs__srv__SetLEDBrightness_Request;
...
size_t get_serialized_size_spot_msgs__srv__SetLEDBrightness_Request(
  const void * untyped_ros_message,
...
static uint32_t _SetLEDBrightness_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_spot_msgs__srv__SetLEDBrightness_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_spot_msgs
size_t max_serialized_size_spot_msgs__srv__SetLEDBrightness_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = spot_msgs__srv__SetLEDBrightness_Request;
    is_plain =
      (
...
static size_t _SetLEDBrightness_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_spot_msgs__srv__SetLEDBrightness_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, spot_msgs, srv, SetLEDBrightness_Request)() {
...
using _SetLEDBrightness_Response__ros_msg_type = spot_msgs__srv__SetLEDBrightness_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_spot_msgs
size_t get_serialized_size_spot_msgs__srv__SetLEDBrightness_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetLEDBrightness_Response__ros_msg_type * ros_message = static_cast<const _SetLEDBrightness_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_spot_msgs__srv__SetLEDBrightness_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_spot_msgs
size_t max_serialized_size_spot_msgs__srv__SetLEDBrightness_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = spot_msgs__srv__SetLEDBrightness_Response;
    is_plain =
      (
...
static size_t _SetLEDBrightness_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_spot_msgs__srv__SetLEDBrightness_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, spot_msgs, srv, SetLEDBrightness_Response)() {
...
// already included above
// #include "spot_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "spot_msgs/srv/set_led_brightness.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, spot_msgs, srv, SetLEDBrightness)() {
