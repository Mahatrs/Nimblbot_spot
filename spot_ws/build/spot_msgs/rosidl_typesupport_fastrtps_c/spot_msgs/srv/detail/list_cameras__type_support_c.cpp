...
#include "spot_msgs/srv/detail/list_cameras__rosidl_typesupport_fastrtps_c.h"
...
using _ListCameras_Request__ros_msg_type = spot_msgs__srv__ListCameras_Request;
...
size_t get_serialized_size_spot_msgs__srv__ListCameras_Request(
  const void * untyped_ros_message,
...
static uint32_t _ListCameras_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_spot_msgs__srv__ListCameras_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_spot_msgs
size_t max_serialized_size_spot_msgs__srv__ListCameras_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = spot_msgs__srv__ListCameras_Request;
    is_plain =
      (
...
static size_t _ListCameras_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_spot_msgs__srv__ListCameras_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, spot_msgs, srv, ListCameras_Request)() {
...
#include "bosdyn_spot_cam_api_msgs/msg/detail/camera__functions.h"  // cameras
#include "rosidl_runtime_c/string.h"  // message
#include "rosidl_runtime_c/string_functions.h"  // message

// forward declare type support functions
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_spot_msgs
size_t get_serialized_size_bosdyn_spot_cam_api_msgs__msg__Camera(
  const void * untyped_ros_message,
  size_t current_alignment);

ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_spot_msgs
size_t max_serialized_size_bosdyn_spot_cam_api_msgs__msg__Camera(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_spot_msgs
const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bosdyn_spot_cam_api_msgs, msg, Camera)();


using _ListCameras_Response__ros_msg_type = spot_msgs__srv__ListCameras_Response;
  ...
  // Field name: cameras
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, bosdyn_spot_cam_api_msgs, msg, Camera
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: cameras
  {
    ...
    if (ros_message->cameras.data) {
      bosdyn_spot_cam_api_msgs__msg__Camera__Sequence__fini(&ros_message->cameras);
    }
    if (!bosdyn_spot_cam_api_msgs__msg__Camera__Sequence__init(&ros_message->cameras, size)) {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_spot_msgs
size_t get_serialized_size_spot_msgs__srv__ListCameras_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ListCameras_Response__ros_msg_type * ros_message = static_cast<const _ListCameras_Response__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name cameras
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_bosdyn_spot_cam_api_msgs__msg__Camera(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_spot_msgs__srv__ListCameras_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_spot_msgs
size_t max_serialized_size_spot_msgs__srv__ListCameras_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: cameras
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_bosdyn_spot_cam_api_msgs__msg__Camera(
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = spot_msgs__srv__ListCameras_Response;
    is_plain =
      (
...
static size_t _ListCameras_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_spot_msgs__srv__ListCameras_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, spot_msgs, srv, ListCameras_Response)() {
...
// already included above
// #include "spot_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "spot_msgs/srv/list_cameras.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, spot_msgs, srv, ListCameras)() {
