...
#include "bosdyn_api_msgs/msg/detail/gripper_camera_get_param_request__functions.h"  // request

// forward declare type support functions
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_spot_msgs
size_t get_serialized_size_bosdyn_api_msgs__msg__GripperCameraGetParamRequest(
  const void * untyped_ros_message,
  size_t current_alignment);

ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_spot_msgs
size_t max_serialized_size_bosdyn_api_msgs__msg__GripperCameraGetParamRequest(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bosdyn_api_msgs, msg, GripperCameraGetParamRequest)();
  ...
  // Field name: request
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, bosdyn_api_msgs, msg, GripperCameraGetParamRequest
      )()->data);
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_bosdyn_api_msgs__msg__GripperCameraGetParamRequest(
  ...
  size_t current_alignment)
{
  ...
  // member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_bosdyn_api_msgs__msg__GripperCameraGetParamRequest(
  ...
  if (is_plain) {
    ...
    using DataType = spot_msgs__srv__GetGripperCameraParameters_Request;
    is_plain =
      (
...
#include "bosdyn_api_msgs/msg/detail/gripper_camera_get_param_response__functions.h"  // response
#include "rosidl_runtime_c/string.h"  // message
#include "rosidl_runtime_c/string_functions.h"  // message

// forward declare type support functions
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_spot_msgs
size_t get_serialized_size_bosdyn_api_msgs__msg__GripperCameraGetParamResponse(
  const void * untyped_ros_message,
  size_t current_alignment);

ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_spot_msgs
size_t max_serialized_size_bosdyn_api_msgs__msg__GripperCameraGetParamResponse(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_spot_msgs
const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bosdyn_api_msgs, msg, GripperCameraGetParamResponse)();
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: response
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, bosdyn_api_msgs, msg, GripperCameraGetParamResponse
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_bosdyn_api_msgs__msg__GripperCameraGetParamResponse(
  ...
  size_t current_alignment)
{
  ...
  // member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_bosdyn_api_msgs__msg__GripperCameraGetParamResponse(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = spot_msgs__srv__GetGripperCameraParameters_Response;
    is_plain =
      (
