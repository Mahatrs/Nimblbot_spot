...
#include "spot_msgs/action/detail/trajectory__rosidl_typesupport_fastrtps_c.h"
...
using _Trajectory_Goal__ros_msg_type = spot_msgs__action__Trajectory_Goal;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: precise_positioning
  {
    cdr << (ros_message->precise_positioning ? true : false);
  }

  // Field name: disable_obstacle_avoidance
  {
    cdr << (ros_message->disable_obstacle_avoidance ? true : false);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: disable_obstacle_avoidance
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->disable_obstacle_avoidance = tmp ? true : false;
  }
...
size_t get_serialized_size_spot_msgs__action__Trajectory_Goal(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Trajectory_Goal__ros_msg_type * ros_message = static_cast<const _Trajectory_Goal__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name disable_obstacle_avoidance
  {
    size_t item_size = sizeof(ros_message->disable_obstacle_avoidance);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
static uint32_t _Trajectory_Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_spot_msgs__action__Trajectory_Goal(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_spot_msgs
size_t max_serialized_size_spot_msgs__action__Trajectory_Goal(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: disable_obstacle_avoidance
  {
    size_t array_size = 1;
  ...
  if (is_plain) {
    ...
    using DataType = spot_msgs__action__Trajectory_Goal;
    is_plain =
      (
      offsetof(DataType, disable_obstacle_avoidance) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Trajectory_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_spot_msgs__action__Trajectory_Goal(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, spot_msgs, action, Trajectory_Goal)() {
...
using _Trajectory_Result__ros_msg_type = spot_msgs__action__Trajectory_Result;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_spot_msgs
size_t get_serialized_size_spot_msgs__action__Trajectory_Result(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Trajectory_Result__ros_msg_type * ros_message = static_cast<const _Trajectory_Result__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_spot_msgs__action__Trajectory_Result(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_spot_msgs
size_t max_serialized_size_spot_msgs__action__Trajectory_Result(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = spot_msgs__action__Trajectory_Result;
    is_plain =
      (
...
static size_t _Trajectory_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_spot_msgs__action__Trajectory_Result(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, spot_msgs, action, Trajectory_Result)() {
...
using _Trajectory_Feedback__ros_msg_type = spot_msgs__action__Trajectory_Feedback;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_spot_msgs
size_t get_serialized_size_spot_msgs__action__Trajectory_Feedback(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Trajectory_Feedback__ros_msg_type * ros_message = static_cast<const _Trajectory_Feedback__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_spot_msgs__action__Trajectory_Feedback(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_spot_msgs
size_t max_serialized_size_spot_msgs__action__Trajectory_Feedback(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = spot_msgs__action__Trajectory_Feedback;
    is_plain =
      (
...
static size_t _Trajectory_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_spot_msgs__action__Trajectory_Feedback(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, spot_msgs, action, Trajectory_Feedback)() {
...
// already included above
// #include "spot_msgs/action/detail/trajectory__functions.h"  // goal
...
using _Trajectory_SendGoal_Request__ros_msg_type = spot_msgs__action__Trajectory_SendGoal_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, spot_msgs, action, Trajectory_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_spot_msgs
size_t get_serialized_size_spot_msgs__action__Trajectory_SendGoal_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Trajectory_SendGoal_Request__ros_msg_type * ros_message = static_cast<const _Trajectory_SendGoal_Request__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_spot_msgs__action__Trajectory_Goal(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_spot_msgs__action__Trajectory_SendGoal_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_spot_msgs
size_t max_serialized_size_spot_msgs__action__Trajectory_SendGoal_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_spot_msgs__action__Trajectory_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = spot_msgs__action__Trajectory_SendGoal_Request;
    is_plain =
      (
...
static size_t _Trajectory_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_spot_msgs__action__Trajectory_SendGoal_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, spot_msgs, action, Trajectory_SendGoal_Request)() {
...
using _Trajectory_SendGoal_Response__ros_msg_type = spot_msgs__action__Trajectory_SendGoal_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_spot_msgs
size_t get_serialized_size_spot_msgs__action__Trajectory_SendGoal_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Trajectory_SendGoal_Response__ros_msg_type * ros_message = static_cast<const _Trajectory_SendGoal_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_spot_msgs__action__Trajectory_SendGoal_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_spot_msgs
size_t max_serialized_size_spot_msgs__action__Trajectory_SendGoal_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = spot_msgs__action__Trajectory_SendGoal_Response;
    is_plain =
      (
...
static size_t _Trajectory_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_spot_msgs__action__Trajectory_SendGoal_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, spot_msgs, action, Trajectory_SendGoal_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, spot_msgs, action, Trajectory_SendGoal)() {
...
using _Trajectory_GetResult_Request__ros_msg_type = spot_msgs__action__Trajectory_GetResult_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_spot_msgs
size_t get_serialized_size_spot_msgs__action__Trajectory_GetResult_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Trajectory_GetResult_Request__ros_msg_type * ros_message = static_cast<const _Trajectory_GetResult_Request__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_spot_msgs__action__Trajectory_GetResult_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_spot_msgs
size_t max_serialized_size_spot_msgs__action__Trajectory_GetResult_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = spot_msgs__action__Trajectory_GetResult_Request;
    is_plain =
      (
...
static size_t _Trajectory_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_spot_msgs__action__Trajectory_GetResult_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, spot_msgs, action, Trajectory_GetResult_Request)() {
...
// already included above
// #include "spot_msgs/action/detail/trajectory__functions.h"  // result
...
using _Trajectory_GetResult_Response__ros_msg_type = spot_msgs__action__Trajectory_GetResult_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, spot_msgs, action, Trajectory_Result
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_spot_msgs
size_t get_serialized_size_spot_msgs__action__Trajectory_GetResult_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Trajectory_GetResult_Response__ros_msg_type * ros_message = static_cast<const _Trajectory_GetResult_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_spot_msgs__action__Trajectory_Result(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_spot_msgs__action__Trajectory_GetResult_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_spot_msgs
size_t max_serialized_size_spot_msgs__action__Trajectory_GetResult_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_spot_msgs__action__Trajectory_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = spot_msgs__action__Trajectory_GetResult_Response;
    is_plain =
      (
...
static size_t _Trajectory_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_spot_msgs__action__Trajectory_GetResult_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, spot_msgs, action, Trajectory_GetResult_Response)() {
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, spot_msgs, action, Trajectory_GetResult)() {
...
// already included above
// #include "spot_msgs/action/detail/trajectory__functions.h"  // feedback
// already included above
// #include "unique_identifier_msgs/msg/detail/uuid__functions.h"  // goal_id
...
using _Trajectory_FeedbackMessage__ros_msg_type = spot_msgs__action__Trajectory_FeedbackMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, spot_msgs, action, Trajectory_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_spot_msgs
size_t get_serialized_size_spot_msgs__action__Trajectory_FeedbackMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Trajectory_FeedbackMessage__ros_msg_type * ros_message = static_cast<const _Trajectory_FeedbackMessage__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_spot_msgs__action__Trajectory_Feedback(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_spot_msgs__action__Trajectory_FeedbackMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_spot_msgs
size_t max_serialized_size_spot_msgs__action__Trajectory_FeedbackMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_spot_msgs__action__Trajectory_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = spot_msgs__action__Trajectory_FeedbackMessage;
    is_plain =
      (
      offsetof(DataType, feedback) +
      last_member_size
...
static size_t _Trajectory_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_spot_msgs__action__Trajectory_FeedbackMessage(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, spot_msgs, action, Trajectory_FeedbackMessage)() {
