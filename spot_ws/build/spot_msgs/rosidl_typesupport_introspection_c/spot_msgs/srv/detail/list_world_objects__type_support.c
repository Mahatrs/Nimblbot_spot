...
// Member `request`
#include "bosdyn_api_msgs/msg/list_world_object_request.h"
// Member `request`
#include "bosdyn_api_msgs/msg/detail/list_world_object_request__rosidl_typesupport_introspection_c.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, spot_msgs, srv, ListWorldObjects_Request)() {
  spot_msgs__srv__ListWorldObjects_Request__rosidl_typesupport_introspection_c__ListWorldObjects_Request_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bosdyn_api_msgs, msg, ListWorldObjectRequest)();
...
// Include directives for member types
// Member `response`
#include "bosdyn_api_msgs/msg/list_world_object_response.h"
// Member `response`
#include "bosdyn_api_msgs/msg/detail/list_world_object_response__rosidl_typesupport_introspection_c.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, spot_msgs, srv, ListWorldObjects_Response)() {
  spot_msgs__srv__ListWorldObjects_Response__rosidl_typesupport_introspection_c__ListWorldObjects_Response_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bosdyn_api_msgs, msg, ListWorldObjectResponse)();
