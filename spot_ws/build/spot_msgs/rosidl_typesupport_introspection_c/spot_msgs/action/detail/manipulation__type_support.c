...
// Member `command`
#include "bosdyn_api_msgs/msg/manipulation_api_request.h"
// Member `command`
#include "bosdyn_api_msgs/msg/detail/manipulation_api_request__rosidl_typesupport_introspection_c.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, spot_msgs, action, Manipulation_Goal)() {
  spot_msgs__action__Manipulation_Goal__rosidl_typesupport_introspection_c__Manipulation_Goal_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bosdyn_api_msgs, msg, ManipulationApiRequest)();
...
// Include directives for member types
// Member `result`
#include "bosdyn_api_msgs/msg/manipulation_api_feedback_response.h"
// Member `result`
#include "bosdyn_api_msgs/msg/detail/manipulation_api_feedback_response__rosidl_typesupport_introspection_c.h"
// Member `message`
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, spot_msgs, action, Manipulation_Result)() {
  spot_msgs__action__Manipulation_Result__rosidl_typesupport_introspection_c__Manipulation_Result_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bosdyn_api_msgs, msg, ManipulationApiFeedbackResponse)();
