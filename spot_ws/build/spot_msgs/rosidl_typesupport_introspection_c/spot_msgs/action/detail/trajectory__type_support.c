...
static rosidl_typesupport_introspection_c__MessageMember spot_msgs__action__Trajectory_Goal__rosidl_typesupport_introspection_c__Trajectory_Goal_message_member_array[4] = {
  {
    "target_pose",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(spot_msgs__action__Trajectory_Goal, disable_obstacle_avoidance),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
