...
bool bosdyn_api_msgs__msg__list_world_object_request__convert_from_py(PyObject * _pymsg, void * _ros_message);
ROSIDL_GENERATOR_C_IMPORT
PyObject * bosdyn_api_msgs__msg__list_world_object_request__convert_to_py(void * raw_ros_message);
...
bool spot_msgs__srv__list_world_objects__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // request
    ...
    if (!bosdyn_api_msgs__msg__list_world_object_request__convert_from_py(field, &ros_message->request)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * spot_msgs__srv__list_world_objects__request__convert_to_py(void * raw_ros_message)
{
  ...
  {  // request
    PyObject * field = NULL;
    field = bosdyn_api_msgs__msg__list_world_object_request__convert_to_py(&ros_message->request);
    if (!field) {
      return NULL;
    }
    {
...
ROSIDL_GENERATOR_C_IMPORT
bool bosdyn_api_msgs__msg__list_world_object_response__convert_from_py(PyObject * _pymsg, void * _ros_message);
ROSIDL_GENERATOR_C_IMPORT
PyObject * bosdyn_api_msgs__msg__list_world_object_response__convert_to_py(void * raw_ros_message);
...
bool spot_msgs__srv__list_world_objects__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // response
    ...
    if (!bosdyn_api_msgs__msg__list_world_object_response__convert_from_py(field, &ros_message->response)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * spot_msgs__srv__list_world_objects__response__convert_to_py(void * raw_ros_message)
{
  ...
  {  // response
    PyObject * field = NULL;
    field = bosdyn_api_msgs__msg__list_world_object_response__convert_to_py(&ros_message->response);
    if (!field) {
      return NULL;
    }
    {
