...
class Metaclass_SetLEDBrightness(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'spot_msgs.srv.SetLEDBrightness')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from spot_msgs.srv import _set_led_brightness
...
class SetLEDBrightness(metaclass=Metaclass_SetLEDBrightness):
    from spot_msgs.srv._set_led_brightness import SetLEDBrightness_Request as Request
    from spot_msgs.srv._set_led_brightness import SetLEDBrightness_Response as Response
