...
class Metaclass_GetGripperCameraParameters_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from bosdyn_api_msgs.msg import GripperCameraGetParamRequest
...
class GetGripperCameraParameters_Request(metaclass=Metaclass_GetGripperCameraParameters_Request):
    ...
    _fields_and_field_types = {
        'request': 'bosdyn_api_msgs/GripperCameraGetParamRequest',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['bosdyn_api_msgs', 'msg'], 'GripperCameraGetParamRequest'),  # noqa: E501
    )
...
class Metaclass_GetGripperCameraParameters_Response(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from bosdyn_api_msgs.msg import GripperCameraGetParamResponse
...
class GetGripperCameraParameters_Response(metaclass=Metaclass_GetGripperCameraParameters_Response):
    ...
    _fields_and_field_types = {
        'response': 'bosdyn_api_msgs/GripperCameraGetParamResponse',
        'success': 'boolean',
        'message': 'string',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['bosdyn_api_msgs', 'msg'], 'GripperCameraGetParamResponse'),  # noqa: E501
