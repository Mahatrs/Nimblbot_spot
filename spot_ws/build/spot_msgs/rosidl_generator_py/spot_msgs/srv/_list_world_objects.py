...
class Metaclass_ListWorldObjects_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from bosdyn_api_msgs.msg import ListWorldObjectRequest
...
class ListWorldObjects_Request(metaclass=Metaclass_ListWorldObjects_Request):
    ...
    _fields_and_field_types = {
        'request': 'bosdyn_api_msgs/ListWorldObjectRequest',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['bosdyn_api_msgs', 'msg'], 'ListWorldObjectRequest'),  # noqa: E501
    )
...
class Metaclass_ListWorldObjects_Response(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from bosdyn_api_msgs.msg import ListWorldObjectResponse
...
class ListWorldObjects_Response(metaclass=Metaclass_ListWorldObjects_Response):
    ...
    _fields_and_field_types = {
        'response': 'bosdyn_api_msgs/ListWorldObjectResponse',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['bosdyn_api_msgs', 'msg'], 'ListWorldObjectResponse'),  # noqa: E501
    )
