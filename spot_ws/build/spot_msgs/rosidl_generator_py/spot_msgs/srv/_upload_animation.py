...
class UploadAnimation_Request(metaclass=Metaclass_UploadAnimation_Request):
    ...
    __slots__ = [
        ...
        '_animation_proto_serialized',
    ]

    _fields_and_field_types = {
        'animation_name': 'string',
        'animation_file_content': 'string',
        'animation_proto_serialized': 'sequence<uint8>',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.animation_proto_serialized = array.array('B', kwargs.get('animation_proto_serialized', []))
    ...
    def __eq__(self, other):
        ...
        if self.animation_file_content != other.animation_file_content:
            return False
        if self.animation_proto_serialized != other.animation_proto_serialized:
            return False
        return True
    ...
    @builtins.property
    def animation_proto_serialized(self):
        """Message field 'animation_proto_serialized'."""
        return self._animation_proto_serialized

    @animation_proto_serialized.setter
    def animation_proto_serialized(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'B', \
                "The 'animation_proto_serialized' array.array() must have the type code of 'B'"
            self._animation_proto_serialized = value
            return
        if __debug__:
            ...
            assert \
                ...
                "The 'animation_proto_serialized' field must be a set or sequence and each value of type 'int' and each unsigned integer in [0, 255]"
        self._animation_proto_serialized = array.array('B', value)
