#pragma message("#include \"forward_state_controller_parameters.hpp\" is deprecated. Use #include <spot_controllers/forward_state_controller_parameters.hpp> instead.")
...
[[nodiscard]] auto to_parameter_value(rsl::StaticVector<T, capacity> const& value) {
  ...
  public:
    ...
    : ParamListener(parameters_interface, rclcpp::get_logger("forward_state_controller"), prefix) {
    ...
    void declare_params(){
      ...
      if (!parameters_interface_->has_parameter(prefix_ + "joints")) {
          ...
          descriptor.description = "Names of the joint to control";
