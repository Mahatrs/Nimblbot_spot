#pragma message("#include \"foot_state_broadcaster_parameters.hpp\" is deprecated. Use #include <spot_controllers/foot_state_broadcaster_parameters.hpp> instead.")
...
namespace foot_state_broadcaster {
...
[[nodiscard]] auto to_parameter_value(rsl::StaticVector<T, capacity> const& value) {
  ...
  public:
    ...
    : ParamListener(parameters_interface, rclcpp::get_logger("foot_state_broadcaster"), prefix) {
    ...
    void declare_params(){
      ...
      if (!parameters_interface_->has_parameter(prefix_ + "use_namespace_as_prefix")) {
          ...
          descriptor.description = "Flag to determine if the prefix of the sensor name should be picked up from the namespace of the controller.";
