#pragma message("#include \"spot_joint_controller_parameters.hpp\" is deprecated. Use #include <spot_controllers/spot_joint_controller_parameters.hpp> instead.")
...
namespace spot_joint_controller {
...
[[nodiscard]] auto to_parameter_value(rsl::StaticVector<T, capacity> const& value) {
  ...
  public:
    ...
    : ParamListener(parameters_interface, rclcpp::get_logger("spot_joint_controller"), prefix) {
    ...
    void declare_params(){
      ...
      if (!parameters_interface_->has_parameter(prefix_ + "joints")) {
          ...
          descriptor.description = "Names of the joints to control";
      ...
      if (!parameters_interface_->has_parameter(prefix_ + "use_namespace_as_prefix")) {
          rcl_interfaces::msg::ParameterDescriptor descriptor;
          descriptor.description = "Flag to determine if the prefix of the joint names should be picked up from the namespace of the controller.";
          descriptor.read_only = false;
