#pragma message("#include \"spot_imu_broadcaster_parameters.hpp\" is deprecated. Use #include <spot_controllers/spot_imu_broadcaster_parameters.hpp> instead.")
...
namespace spot_imu_broadcaster {
...
[[nodiscard]] auto to_parameter_value(rsl::StaticVector<T, capacity> const& value) {
    ...
    struct Params {
        ...
        std::string frame_id = "imu_sensor_frame";
  ...
  public:
    ...
    : ParamListener(parameters_interface, rclcpp::get_logger("spot_imu_broadcaster"), prefix) {
    ...
    void declare_params(){
      ...
      if (!parameters_interface_->has_parameter(prefix_ + "use_namespace_as_prefix")) {
          ...
          descriptor.description = "Flag to determine if the prefix for the IMU sensor should be picked up from the namespace of the controller.";
