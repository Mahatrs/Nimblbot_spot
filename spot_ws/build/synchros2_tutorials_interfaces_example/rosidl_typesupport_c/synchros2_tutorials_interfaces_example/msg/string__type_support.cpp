...
static const _String_type_support_symbol_names_t _String_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, synchros2_tutorials_interfaces_example, msg, String)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, synchros2_tutorials_interfaces_example, msg, String)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, synchros2_tutorials_interfaces_example, msg, String)() {
  return &::synchros2_tutorials_interfaces_example::msg::rosidl_typesupport_c::String_message_type_support_handle;
}
