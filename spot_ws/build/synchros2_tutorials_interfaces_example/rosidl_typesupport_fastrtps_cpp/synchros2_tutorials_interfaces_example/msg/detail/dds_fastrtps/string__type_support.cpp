...
#include "synchros2_tutorials_interfaces_example/msg/detail/string__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = synchros2_tutorials_interfaces_example::msg::String;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const synchros2_tutorials_interfaces_example::msg::String *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<synchros2_tutorials_interfaces_example::msg::String *>(
    untyped_ros_message);
...
{
  return &synchros2_tutorials_interfaces_example::msg::typesupport_fastrtps_cpp::_String__handle;
}
