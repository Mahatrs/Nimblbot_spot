...
{
  new (message_memory) synchros2_tutorials_interfaces_example::msg::String(_init);
}

void String_fini_function(void * message_memory)
{
  auto typed_message = static_cast<synchros2_tutorials_interfaces_example::msg::String *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember String_message_member_array[1] = {
  {
    ...
    offsetof(synchros2_tutorials_interfaces_example::msg::String, data),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers String_message_members = {
  "synchros2_tutorials_interfaces_example::msg",  // message namespace
  "String",  // message name
  1,  // number of fields
  sizeof(synchros2_tutorials_interfaces_example::msg::String),
...
get_message_type_support_handle<synchros2_tutorials_interfaces_example::msg::String>()
{
  return &::synchros2_tutorials_interfaces_example::msg::rosidl_typesupport_introspection_cpp::String_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, synchros2_tutorials_interfaces_example, msg, String)() {
  return &::synchros2_tutorials_interfaces_example::msg::rosidl_typesupport_introspection_cpp::String_message_type_support_handle;
}
