...
#define NODE_MAIN_LOGGER_NAME "spot_image_publisher_node_component"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libspot_image_publisher_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<spot_ros2::images::SpotImagePublisherNode>";
