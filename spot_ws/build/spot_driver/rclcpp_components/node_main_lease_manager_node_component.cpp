...
#define NODE_MAIN_LOGGER_NAME "lease_manager_node_component"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liblease_manager_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<spot_ros2::LeaseManagerNode>";
