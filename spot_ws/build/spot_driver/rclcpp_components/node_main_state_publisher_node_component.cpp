...
#define NODE_MAIN_LOGGER_NAME "state_publisher_node_component"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libstate_publisher_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<spot_ros2::StatePublisherNode>";
