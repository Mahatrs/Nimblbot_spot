...
#define NODE_MAIN_LOGGER_NAME "spot_inverse_kinematics_node_component"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libspot_inverse_kinematics_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<spot_ros2::kinematic::KinematicNode>";
